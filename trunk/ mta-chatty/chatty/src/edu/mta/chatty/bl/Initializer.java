...
public class Initializer {
	public static class InitData{
		...
		public List<BuddyList> buddy_list;
		public List<Group> groups;
		public List<BuddyMessages> buddy_messages;
		public List<GroupMemberships> group_memberships;
		public List<GroupMessages> group_messages;
		
	}


	
	private static class TestJsonInit{
		private static abstract class InsertHandler<T> implements SafeBatchInsert<T>{
			@Override
		...
		private TestJsonInit(DataSource ds){
		...
		private void insertCountries(final List<Country> data) throws SQLException{
			batchInsert.execute(new InsertHandler<Country>() {
				...
				@Override
				public void setVariables(PreparedStatement statement, Country t) throws SQLException{
		...
		private void insertCities(final List<City> data) throws SQLException{
			batchInsert.execute(new InsertHandler<City>() {
				...
				@Override
				public void setVariables(PreparedStatement statement, City t) throws SQLException{
		...
		private void insertAddresses(final List<Address> data) throws SQLException{
			batchInsert.execute(new InsertHandler<Address>() {
				...
				@Override
				public void setVariables(PreparedStatement statement, Address t) throws SQLException{
		...
		private void insertUsers(final List<User> data) throws SQLException{
			batchInsert.execute(new InsertHandler<User>() {
				...
				@Override
				public void setVariables(PreparedStatement statement, User t) throws SQLException{
		...
		private void insertBuddyList(final List<BuddyList> data) throws SQLException{
			batchInsert.execute(new InsertHandler<BuddyList>() {
				...
				@Override
				public void setVariables(PreparedStatement statement, BuddyList t) throws SQLException{
		...
		private void insertGroups(final List<Group> data) throws SQLException{
			batchInsert.execute(new InsertHandler<Group>() {
				...
				@Override
				public void setVariables(PreparedStatement statement, Group t) throws SQLException{
		...
		private void insertBuddyMessages(final List<BuddyMessages> data) throws SQLException{
			batchInsert.execute(new InsertHandler<BuddyMessages>() {
				...
				@Override
				public void setVariables(PreparedStatement statement, BuddyMessages t) throws SQLException{
		...
		private void insertGroupMemberships(final List<GroupMemberships> data) throws SQLException{
			batchInsert.execute(new InsertHandler<GroupMemberships>() {
				...
				@Override
				public void setVariables(PreparedStatement statement, GroupMemberships t) throws SQLException{
		...
		private void insertGroupMessages(final List<GroupMessages> data) throws SQLException{
			batchInsert.execute(new InsertHandler<GroupMessages>() {
				...
				@Override
				public void setVariables(PreparedStatement statement, GroupMessages t) throws SQLException{
					statement.setString(1, t.getSender_id());
	...
	private final TestJsonInit jsonInit;

	public Initializer(DataSource ds){
		this.helper=new DBHelper(ds);
		this.jsonInit = new TestJsonInit(ds);
	}
	...
	public boolean loadTestData(ServletContext context){
		try {
			return jsonInit.loadInitData(context);
		}catch (Exception e){
